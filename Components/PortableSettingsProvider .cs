// https://www.codeproject.com/Articles/20917/Creating-a-Custom-Settings-Provider?msg=2934144#xx2934144xx
...
public class PortableSettingsProvider : SettingsProvider
{
    string _fileName;
    string _filePath;
    public PortableSettingsProvider(string fileName, bool Portable = true)
    {
        _fileName = fileName;
        if (Portable)
            _filePath = Application.StartupPath + "\\UserSettings";
        else
            _filePath = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\\" + Application.ProductName;
    }
