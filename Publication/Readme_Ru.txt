...
Программа не модифицирует системный реестр и файлы Windows (за исключением опции "Автозапуск при входе пользователя"). Чтобы освободить место на диске, можно удалить каталоги с ненужными переводами UI (названными по локали).
