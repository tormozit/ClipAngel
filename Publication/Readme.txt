...
ClipAngelPortable.bat or parameter /p - runs application in portable mode, settings and standart database will be loaded/saved in the same catalog, where program is started.

Parameter /m - runs application in minimized mode.

To free disk space you can delete catalogs with unneeded UI translations (named by locales).